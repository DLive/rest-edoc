...
tags() ->
    ...
    [{author, fun parse_contact/4, [module,overview]},
     ...
     {info,text,[module]},
     {title,text,[module]},
     {description,text,[module,funtion,overview]},
     % {version,text,[module,funtion,overview]},
     {host,text,[module,overview]},
     {schemes,text,[module,overview]},
     {basePath,text,[module,overview]},
     {produces,text,[module,funtion,overview]},
     {path,text,[funtion]},
     {method,text,[funtion]},
     {parameter,text,[funtion]},
     {responses,text,[funtion]}
     ].
